...
def make_valid_intent(**overrides) -> dict:
    payload = {
        "user_id": "llm_should_not_control_this",
        "agent_id": "llm_should_not_control_this",
        "intent_id": "llm_should_not_control_this",
        "raw_user_prompt": "llm_should_not_control_this",
...
def test_server_owned_fields_override_llm_output():
    response = make_valid_analysis(
        raw_user_prompt="LLM'S FAKE PROMPT",
        intent_proposal={
            "user_id": "fake_user",
            "agent_id": "fake_agent",
...
def test_llm_request_does_not_contain_server_secrets():
    response = make_valid_analysis()
